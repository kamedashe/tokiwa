 ...
 *
 * Вошёл человек или нет, говорит только signedIn. Имя и аватар бывают
 * пустыми и у вошедших, так что судить по ним нельзя: ровно на этом сайт
 * восемь дней показывал меню профиля всем подряд и прятал кнопку «Войти».
 */
