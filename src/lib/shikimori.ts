...
/** .one теперь редиректит 301 на .io на каждый запрос без исключений —
 *  дёргаем конечный домен напрямую, чтобы не платить лишним обходом. */
const BASE = "https://shikimori.io/api";
